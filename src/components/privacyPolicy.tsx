...
export function PrivacyPolicy(){
    return(
      <PolicySection>
          <PolicyHeading>
            <Heading className="policy">gmgmbot Privacy Policy</Heading>
          <p>Last updated: 2023-03-16</p>
          </PolicyHeading>

          <PolicyText>
              <Heading className="policy border">Introduction</Heading>
              <TextM className="policy ">Welcome to gmgmbot. <br />
                gmgmbot (“us”, “we”, or “our”) operates www.gmgmbot.com (hereinafter referred to as “Service”). Our Privacy Policy governs your visit to www.gmgmbot.io, and explains how we collect, safeguard and disclose information that results from your use of our Service. We use your data to provide and improve Service. By using Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions. Our Terms and Conditions (“Terms”) govern all use of our Service and together with the Privacy Policy constitutes your agreement with us (“agreement”).
              </TextM>
          </PolicyText>
...
We use cookies and similar tracking technologies to track the activity on our Service and we hold certain information. Cookies are files with a small amount of data which may include an anonymous unique identifier. Cookies are sent to your browser from a website and stored on your device. Other tracking technologies are also used such as beacons, tags and scripts to collect and track information and to improve and analyze our Service. You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. However, if you do not accept cookies, you may not be able to use some portions of our Service. Examples of Cookies we use:
          ...
          <PolicyText>
              ...
              <TextM className="policy ">
              gmgmbot uses the collected data for various purposes:
<br />
...
<br />
0.4. users are able to change their personal information by emailing us at team@gmgmbot.io.
<br />
...
If you submit a request to stop selling your personal information, we will stop making such transfers. Please note, if you ask us to delete or stop selling your data, it may impact your experience with us, and you may not be able to participate in certain programs or membership services which require the usage of your personal information to function. But in no circumstances, we will discriminate against you for exercising your rights. To exercise your California data protection rights described above, please send your request(s) by email: team@gmgmbot.io. Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy Act. To find out more, visit the official California Legislative Information website. The CCPA took effect on 01/01/2020.
          ...
          <PolicyText>
              ...
              <TextM className="policy ">
              If you have any questions about this Privacy Policy, please contact us by email: team@gmgmbot.io.
              </TextM>
          </PolicyText>

          <PolicyText>
              <TextM className="policy ">
              This Privacy Policy was created for www.gmgmbot.com by PolicyMaker.io on 2023-03-16.
              </TextM>
          </PolicyText>
      </PolicySection>
    )
