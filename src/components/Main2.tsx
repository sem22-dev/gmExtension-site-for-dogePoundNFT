...
export function Main2(){
    return(
        <AdvertiseContainer>
            ...
            <Youtube><iframe width="350" height="200" src="https://www.youtube.com/watch?v=p26MRvJjQdo" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe></Youtube>
            </VideoGuide>
            <TeamContainer>
